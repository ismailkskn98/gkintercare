...
import { createContactEmail } from "@/lib/mail/templates";
...
export async function POST(request) {
  try {
    ...
    const isValid = values.fullName && emailPattern.test(values.email) && values.phone && values.country && values.message && values.consent;
    ...
    console.error("Contact form email could not be sent", error);
