...
const englishContent = {
  ...
  footer: {
    ...
    newsletter: {
      ...
      sending: "Sending...",
      success: "Thanks. Our team will be in touch soon.",
  ...
  home: {
    hero: {
      ...
      formStatus: {
        ...
        success: "Thank you. Our patient coordination team will contact you shortly.",
        error: "We could not send your request. Please try again.",
  ...
  partnersPage: {
    ...
    form: {
      ...
      fields: {
        fullName: { label: "Full name", placeholder: "Your full name" },
        companyName: { label: "Company name", placeholder: "Your company or organisation" },
        businessType: {
          label: "Organisation type",
          placeholder: "Select your organisation type",
          options: [
            { value: "medical-travel-agency", label: "Medical travel agency" },
            { value: "clinic-or-hospital", label: "Clinic or hospital" },
            { value: "referral-partner", label: "Referral partner" },
            { value: "other", label: "Other" },
          ],
        },
        email: { label: "Business email", placeholder: "you@company.com" },
        phone: { label: "WhatsApp or phone", placeholder: "+90 532 123 45 67" },
        country: { label: "Country", placeholder: "Where is your organisation based?" },
        monthlyPatients: {
          label: "Monthly patient volume",
          placeholder: "Select an estimate",
          options: [
            { value: "1-5", label: "1-5 patients / month" },
            { value: "6-20", label: "6-20 patients / month" },
            { value: "21-50", label: "21-50 patients / month" },
            { value: "51-plus", label: "51+ patients / month" },
          ],
        },
      },
      ...
      status: {
        sending: "Sending request...",
        success: "Thank you. Our partnership team will contact you shortly.",
        error: "We could not send your request. Please try again.",
      },
...
const spanishOverrides = {
  ...
  footer: {
    ...
    newsletter: {
      ...
      sending: "Enviando...",
      success: "Gracias. Nuestro equipo se pondra en contacto pronto.",
      error: "No pudimos enviar tu solicitud. Intentalo de nuevo.",
      requiredError: "Introduce tu correo electronico.",
  ...
  home: {
    hero: {
      ...
      formStatus: {
        ...
        success: "Gracias. Nuestro equipo de coordinacion de pacientes te contactara pronto.",
        error: "No pudimos enviar tu solicitud. Intentalo de nuevo.",
  ...
  partnersPage: {
    ...
    form: {
      ...
      fields: {
        fullName: { label: "Nombre completo", placeholder: "Tu nombre completo" },
        companyName: { label: "Nombre de la empresa", placeholder: "Tu empresa u organizacion" },
        businessType: {
          label: "Tipo de organizacion",
          placeholder: "Selecciona el tipo de organizacion",
          options: [
            { value: "medical-travel-agency", label: "Agencia de turismo medico" },
            { value: "clinic-or-hospital", label: "Clinica u hospital" },
            { value: "referral-partner", label: "Socio de referencia" },
            { value: "other", label: "Otro" },
          ],
        },
        email: { label: "Email de empresa", placeholder: "tu@empresa.com" },
        phone: { label: "WhatsApp o telefono", placeholder: "+90 532 123 45 67" },
        country: { label: "Pais", placeholder: "Donde esta tu organizacion?" },
        monthlyPatients: {
          label: "Volumen mensual de pacientes",
          placeholder: "Selecciona una estimacion",
          options: [
            { value: "1-5", label: "1-5 pacientes / mes" },
            { value: "6-20", label: "6-20 pacientes / mes" },
            { value: "21-50", label: "21-50 pacientes / mes" },
            { value: "51-plus", label: "51+ pacientes / mes" },
          ],
        },
      },
      ...
      status: {
        sending: "Enviando solicitud...",
        success: "Gracias. Nuestro equipo de alianzas te contactara pronto.",
        error: "No pudimos enviar tu solicitud. Intentalo de nuevo.",
      },
      button: "Conviértete en socio",
    },
    cta: {
      label: "Una linea directa con nuestro equipo de alianzas",
...
const italianOverrides = {
  ...
  footer: {
    ...
    newsletter: {
      ...
      success: "Grazie. Il nostro team ti contattera presto.",
      error: "Non siamo riusciti a inviare la richiesta. Riprova.",
      requiredError: "Inserisci il tuo indirizzo email.",
  ...
  home: {
    hero: {
      ...
      formStatus: {
        ...
        success: "Grazie. Il nostro team di coordinamento pazienti ti contattera presto.",
        error: "Non siamo riusciti a inviare la richiesta. Riprova.",
  ...
  partnersPage: {
    ...
    form: {
      ...
      fields: {
        fullName: { label: "Nome completo", placeholder: "Il tuo nome completo" },
        companyName: { label: "Nome azienda", placeholder: "La tua azienda o organizzazione" },
        businessType: {
          label: "Tipo di organizzazione",
          placeholder: "Seleziona il tipo di organizzazione",
          options: [
            { value: "medical-travel-agency", label: "Agenzia di turismo medico" },
            { value: "clinic-or-hospital", label: "Clinica o ospedale" },
            { value: "referral-partner", label: "Partner di segnalazione" },
            { value: "other", label: "Altro" },
          ],
        },
        email: { label: "Email aziendale", placeholder: "tu@azienda.com" },
        phone: { label: "WhatsApp o telefono", placeholder: "+90 532 123 45 67" },
        country: { label: "Paese", placeholder: "Dove ha sede la tua organizzazione?" },
        monthlyPatients: {
          label: "Volume mensile di pazienti",
          placeholder: "Seleziona una stima",
          options: [
            { value: "1-5", label: "1-5 pazienti / mese" },
            { value: "6-20", label: "6-20 pazienti / mese" },
            { value: "21-50", label: "21-50 pazienti / mese" },
            { value: "51-plus", label: "51+ pazienti / mese" },
          ],
        },
      },
      ...
      status: {
        sending: "Invio della richiesta...",
        success: "Grazie. Il nostro team partnership ti contattera presto.",
        error: "Non siamo riusciti a inviare la richiesta. Riprova.",
      },
      button: "Diventa partner",
    },
    cta: {
      label: "Una linea diretta con il nostro team partnership",
