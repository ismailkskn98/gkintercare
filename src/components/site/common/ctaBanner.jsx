...
export default function CtaBanner({
  ...
  return (
    <section className={`gridContainer ${className}`}>
      <div className="relative min-h-[16rem] overflow-hidden rounded-[8px] bg-primary px-6 py-8 text-white shadow-[0_22px_70px_rgba(11,60,93,0.16)] md:min-h-[18rem] md:px-9 md:py-10">
        <Image
          src={image}
          alt={imageAlt}
          fill
